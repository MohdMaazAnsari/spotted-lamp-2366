...
useEffect(()=>{
const url=`https://first-cry.onrender.com/products?_sort=price&_order=${order}`

  getData(url)  
  
  },[order,])

// ____sortingggggggggg
const handleSort=()=>{
...
let url;
if(value===''){
  url=`https://first-cry.onrender.com/products?_sort=price&_order=${order}`
}
else{
  url=`https://first-cry.onrender.com/products?name=${value}`
}
getData(url)
...
const handleChange=(e)=>{
  ...
  const value=e.target.value
    ...
    url=`https://first-cry.onrender.com/products?q=${value}`
